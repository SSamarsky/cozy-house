...
pets.map((el) => {
  ...
  item.addEventListener("click", () => textPopup(el));
});
...
const sliderItem = sliderBox.querySelectorAll(".slider__item");
...
function textPopup(el) {
  popup.querySelector(".popup__name").textContent = el["name"];
  popup.querySelector(".popup__breed").textContent = el["breed"];
  popup.querySelector(".popup__text").textContent = el["description"];
  popup.querySelector(
    ".popup__photo"
  ).style.backgroundImage = `url(../../assets/images/pets/${el.name}.png)`;
  popup.querySelector("#pet__age").textContent = el["age"];
  popup.querySelector("#pet__inoculations").textContent = el["inoculations"];
  popup.querySelector("#pet__diseases").textContent = el["diseases"];
  popup.querySelector("#pet__parasites").textContent = el["parasites"];
}
